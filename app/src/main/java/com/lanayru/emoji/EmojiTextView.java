...
@SuppressWarnings("CPD-START") public class EmojiTextView extends AppCompatTextView {
  ...
  @Override @CallSuper
  public void setText(final CharSequence rawText, final TextView.BufferType type) {
    final CharSequence text = rawText == null ? "" : rawText;
    final SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(text);
    final Paint.FontMetrics fontMetrics = getPaint().getFontMetrics();
    final float defaultEmojiSize = fontMetrics.descent - fontMetrics.ascent;
    EmojiManager.INSTANCE.replaceWithImages(getContext(), spannableStringBuilder, emojiSize, defaultEmojiSize);
